...
//         const db = client.db(process.env.MONGODB_DB); // 假設你的 collection 在 users DB 中
...
// // 待測試
// export async function POST(req: NextRequest, { params }: { params: { pdfId: string } }) {
//     const session = await getServerSession(authOptions);
